    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header bg-dark text-white px-2 py-1">
          <h1 class="modal-title" style="font-size: 14px !important;">REGISTRAR LENTE TERMINADO</h1>
                ...
                <div class="card-body p-1">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="content-input">
                                    <input type="text" name="marca_lente" title="marca" placeholder=" " class="input">
                                    <label class="input-label">Marca</label>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="content-input">
                                    <input type="text" name="diseno_lente" title="diseño" placeholder=" " class="input">
